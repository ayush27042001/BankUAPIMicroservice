...
{
    public sealed record AepsLoginRequest
    (
        string UserId,
        string SpKey,
        ...
        string Latitude,
        string Longitude,
        BiometricPidDataAEPS PidData
    );

    public sealed record BiometricPidDataAEPS
    (
    ...
    public sealed class AepsLoginApiPayload
    {
        public string type { get; init; } = "DAILY_LOGIN";
        public string externalRef { get; init; }
        public string latitude { get; init; }
        public string longitude { get; init; }
        public BiometricDataInsLogin biometricData { get; init; }
        public sealed class BiometricDataInsLogin
        {
