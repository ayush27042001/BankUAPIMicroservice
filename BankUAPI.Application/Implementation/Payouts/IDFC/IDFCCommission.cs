...
{
    public class IDFCCommission: IIDFCCommissionService
    {
        private readonly AppDbContext _db;
        private readonly ICommissionDistributionService _commisionDis;

        public IDFCCommission(AppDbContext db, ICommissionDistributionService commissionDistributionService)
        {
            _db = db;
        ...
        //private static void Validate(CommissionRate r)
        //{
        //    if (r.Retailer < r.Distributor || r.Distributor < r.Admin)
        //        throw new Exception("Invalid DMT commission hierarchy");
        //}
